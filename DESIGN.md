...
#### 2.7.3 업로드 버튼 `.upload-btn` · `globals.css:553-564`
...
#### 2.7.4 필드 인풋 `.field-input` · `globals.css:568-574`
...
#### 2.7.4b 여러 줄 필드 `.field-textarea` · `globals.css:576-583`
...
#### 2.7.5 읽기전용 필드 `.field-readonly` (+`__value`) · `globals.css:584-589`
...
### 4.4 마이 페이지 `/mypage` · `app/(app)/mypage/page.tsx` + `.mypage*`(`globals.css:541-605`)
...
| `app/globals.css` 마이(541–605) | mypage-*/upload-btn/field-*(input/textarea/readonly)/saved-note/logout-card | §4.4, §2.7 |
