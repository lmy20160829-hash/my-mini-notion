...
> **진행 기록 (2026-07-22):** 에디터 고도화 스프린트 **완료·배포** — 9개 기능(플로팅
> 툴바·슬래시 메뉴·드래그 핸들·블록 11종·페이지 중첩·본문 이미지·이모지 아이콘·
> 첨부 업로드·템플릿) 전부 ium.ai.kr 반영, 육안 확인 완료. Tiptap 3.28.0(MIT),
> dual read/write(content_doc) 손실 제로 이행. 스펙: `docs/superpowers/specs/
> 2026-07-21-editor-*.md`. 검증 기준선 457 테스트/빌드 통과(커밋 2eb6340).
> 다음 스프린트 = 아래 "데이터베이스" 항목.
